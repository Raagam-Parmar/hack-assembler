...
let sym_tbl = Machine.make_hash_symbol program_ast
let lbl_tbl = Machine.make_hash_label program_ast


(** The following function creates the machine instructions for as a list [binary_list] *)
let binary_list = Machine.resolve_statements_string sym_tbl lbl_tbl program_ast
